...
namespace A2B_Teleport
{
	public class BeltTeleporterComponent : BeltComponent
	{
        ...
        public override void OnItemTransfer(Thing item, BeltComponent other)
        {
			...
			int minPuffs = (A2BTeleportData.Teleportation.isResearched ? 1 : 4);
			int maxPuffs = (A2BTeleportData.Teleportation.isResearched ? 2 : 6);

			float heat = PowerComponent.PowerOutput / basePowerConsumption * A2BTeleportData.Teleportation.DegreesPerCell;
